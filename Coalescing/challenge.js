//1. Explicitly check for title
    ...
    // }
     ...
     //3. Explicitly check if yearPublished is undefined or null
    // refactor the below code
    // if (yearPublished === undefined || yearPublished === null) {
    //     yearPublished = 'Not Specified'
    // }

      //4. Explicitly check for availability at main library
    // refactor the below code :-
    // if (libraryData) {
